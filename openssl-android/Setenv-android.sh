...
if [ ! -z "$VERBOSE" ] && [ "$VERBOSE" != "0" ]; then
  echo "setenv ANDROID_NDK_ROOT $ANDROID_NDK_ROOT"
  echo "setenv ANDROID_ARCH $_ANDROID_ARCH"
  echo "setenv ANDROID_EABI $_ANDROID_EABI"
  echo "setenv ANDROID_API $ANDROID_API"
  echo "setenv ANDROID_SYSROOT $ANDROID_SYSROOT"
  echo "setenv ANDROID_TOOLCHAIN $ANDROID_TOOLCHAIN"
  echo "setenv CROSS_COMPILE $CROSS_COMPILE"
  echo "setenv ANDROID_DEV $ANDROID_DEV"
fi
